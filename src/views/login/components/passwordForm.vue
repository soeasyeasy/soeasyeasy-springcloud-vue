			...
			<el-input v-model="form.user" prefix-icon="el-icon-user" clearable
				...
				<template #append>
					<el-select v-model="userType" style="width: 130px;">
						...
						<el-option :label="租户test" value="test"></el-option>
						<el-option :label="租户test1" value="test1"></el-option>
						<el-option :label="租户test2" value="test2"></el-option>
					</el-select>
				</template>
			</el-input>
		</el-form-item>
	...
	methods: {
		async login() {
			...
			var data = {
				...
				loginType: "password",
				tenantId: this.userType
			}
			if (this.userType == "选择租户") {
