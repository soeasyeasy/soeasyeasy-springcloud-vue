				...
				<el-container>
					...
					<el-main class="nopadding">
						<scTable ref="table" :apiObj="apiObj" stripe highlightCurrentRow @row-click="rowClick">
							...
							<el-table-column label="入参" prop="args" width="150"
								show-overflow-tooltip="false"></el-table-column>
							<el-table-column label="出参" prop="result" width="300"
								show-overflow-tooltip="false"></el-table-column>
							<el-table-column label="用户" prop="user" width="150"></el-table-column>
							<el-table-column label="客户端IP" prop="clientIp" width="200"></el-table-column>
							<el-table-column label="日志时间" prop="startTime" width="170"></el-table-column>
						</scTable>
					</el-main>
				</el-container>
			</el-main>
